...
const Register = () => {
  ...
  return (
    <div className="w-screen h-screen bg-gradient-to-r from-slate-950 to-purple-950 flex items-center justify-center ">
      <form className="flex flex-col gap-2 text-white bg-slate-800 p-6 w-96 rounded-lg shadow-lg" onSubmit={onSubmit}>
        ...
        <Button type="submit" className="bg-secondaryBtn text-white font-black rounded-xl mt-6 hover:bg-purple-700 transition-all duration-300 shadow-lg">
          Register
        </Button>
